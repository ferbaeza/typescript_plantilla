...
const DatabaseConnection_1 = require("../Database/Config/DatabaseConnection");
const homeRoute_1 = __importDefault(require("../Providers/homeRoute"));
...
class Server {
    ...
    routes() {
        this.express.use("/", homeRoute_1.default);
